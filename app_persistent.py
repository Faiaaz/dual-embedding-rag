...
def health_check():
    ...
    return jsonify({
        'status': 'healthy',
        'message': 'Persistent RAG API is running',
        'documents_count': len(rag.documents),
        'method': 'TF-IDF with file persistence',
...
def home():
    ...
    return jsonify({
        'message': 'Welcome to the Persistent RAG API!',
        'note': 'Documents are saved to file and persist between restarts',
        'storage_file': rag.storage_file,
        'endpoints': {
